  ...
  return (
    <div className="sidenav">
      ...
      <div className={divArr[0]}>
        <img
          src={require('../../docs/learn-icon-white.png')}
          alt="mnemosyne-logo"
          className="icons"
        />
      ...
      <div className={divArr[1]}>
        <img
          src={require('../../docs/create-icon-white.png')}
          alt="mnemosyne-logo"
          className="icons"
        />
      ...
      <div className={divArr[2]}>
        <img
          src={require('../../docs/practice-icon-white.png')}
          alt="mnemosyne-logo"
          className="icons"
        />
