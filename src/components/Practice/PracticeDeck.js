...
export default function PracticeDeck(props) {
  ...
  const shuffleDefinitions = current => {
    ...
    const selected = [
      withoutTerm[0],
      term,
      withoutTerm[withoutTerm.length - 1],
    ];
    setDefinitions(
      ...
      <div className="test">
        ...
        <div className="game-big-wrap">
          <div className="game-info-bar">
            ...
            <div className="deck-info-wrap">
              <span className="deck-subject">
                {!loading && shuffled[0].subject_name.toUpperCase()}
              </span>
              <span className="deck-title">
                {!loading && shuffled[0].deck_name}
              </span>
              <span className="deck-description">
                {!loading && shuffled[0].deck_description}
              </span>
            </div>

            <div className="practice-card-number-container">
              <img
                src={require('../../../docs/questions.png')}
                id="card-icon"
              />
            ...
            <div className="practice-card-number-container">
              <img
                src={require('../../../docs/right-answer.png')}
                id="card-icon"
              />
            ...
            <div className="practice-card-number-container">
              <img
                src={require('../../../docs/wrong-answer.png')}
                id="card-icon"
              />
            ...
            {start && (
              <div id="exit" onClick={() => setBack(true)}>
            ...
            <div className="playcards-list">
              {start && (
                <PracticeTerm
                  ...
                  id={t.id}
                  term={t.term}
                  cheating="That's cheating, my friend!"
                />
              )}
          ...
          {gameOver && (
            <div id="scorenote">
              <div id="grade">
                Congrats! You have answered {correct} cards correctly. Score:{' '}
                {Math.round((correct / deckLength) * 100)}/100
                <div className="link-scores">
                  <a href="/profile" className="link-scores">
                    View all scores
                  </a>
                </div>
              </div>
